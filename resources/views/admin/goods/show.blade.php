                                ...
                                <label class="mws-form-label"> 商品颜色:</label>
                                      <div class="mws-form-item">
                                        <select  name="goods_attr_color">
                                            ...
                                            <option value="1" {{good -> goods_attr_color ? 'selected' :''}}>玉米黄</option>
                                            <option value="2" {{good -> goods_attr_color ? 'selected' :''}}>象牙白</option>
                                            <option value="3" {{good -> goods_attr_color ? 'selected' :''}}>橘红</option>
                                            <option value="4" {{good -> goods_attr_color ? 'selected' :''}}>火焰红</option>
                                            <option value="5" {{good -> goods_attr_color ? 'selected' :''}}>胭脂红</option>
                                            <option value="6" {{good -> goods_attr_color ? 'selected' :''}}>珍珠黑</option>
                                            <option value="7" {{good -> goods_attr_color ? 'selected' :''}}>天青蓝</option>
