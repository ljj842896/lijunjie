                ...
                <li class="inline last">
                    ...
                    <div class="app_box">
                        ...
                        <div class="bg_fff down_list_box">
                            ...
                            <a class="inline" href="/Home/address">地址管理</a>
...
<script src="/h/pc/www/js/mycenter/personal_deliveryAddress.js?v=biyao_df0f94c"></script>
<script src="/h/pc/common/js/ui/loadmask.js?v=biyao_5aac5cc" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
