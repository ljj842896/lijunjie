            ...
            <div >
                ...
                <div class="J_table_wrap">
					...
					<span class="f_l col_666">
					 <span class="col_b2b2b2">2016-08-05 &nbsp;&nbsp;</span>
					 <label> 订单编号：122007043946180978</label>
					</span><span class="f_r">&nbsp;&nbsp;
					<script>
                        ...
                        <table cellspacing="0" cellpadding="0" class="sop_table4 border ">
                            ...
                            <tr data-unfacceptance="0"
                                        ...
                                        <tr>
                                            <td name="detail_td">
                                                <a class="perCmImg inline mg_l10" target="_blank" href="/products/1300910000000030000-0.html#editor">
                                                    <img alt="" src="/h/http://img.biyao.com/files/temp/render_zs/result/1300910000/272079c5d789a84c_130091000000003_0_800_363/img_6_800_200.jpg">
                                                </a>
                                                <div class="inline mg_l10 vTop mg_t5 lineH20 w190">
                                                    <a class="col_666" href="/products/1300910000000030000-0.html#editor" target="_blank">
                                                        <span class="col_666">女士丝印进口牛皮休闲购物包</span>
                                                    </a><br>
                                ...
                                <td width="18%" align="center" class="bd_l vTop pd_t15 lineH20"><strong
                                        class="col_f60 f14">￥399</strong>
                                    <br> <span>（运费：￥0）</span>
                                </td>
                                <td width="18%" align="center" class="bd_l vTop pd_t15 lineH20">
                                    <span class="col_f60">待付款</span>
                                    <br>

                                    <a href="MyOrderDetail.html" class="col_link ">订单详情</a>
                                    <br />
...
<script type="text/javascript" src="/h/pc/common/js/common.js?v=biyao_c83c46d"></script>
...
<script type="text/javascript" src="/h/pc/common/js/ui/jquery.validate.js?v=biyao_20c474d"></script>
<script type="text/javascript" src="/h/pc/www/js/mycenter/mycenter.js?v=biyao_63cad99"></script>
<script type="text/javascript"	src="/h/pc/www/js/common.js?v=biyao_bd8bd36"></script>
<script src="/h/pc/www/js/mycenter/myorderdetail-list.js?v=biyao_eb1ba46"
        type="text/javascript"></script>
<script src="/h/pc/www/js/mycenter/myOrderIndex.js?v=biyao_b92d9e8"
        type="text/javascript"></script>
<script src="/h/pc/common/js/ui/validate.js?v=biyao_8c8263d"
        type="text/javascript"></script>
<script src="/h/pc/www/js/mycenter/cancelOrder.js?v=biyao_1e4bfed"
        type="text/javascript"></script>
<script src="/h/pc/www/js/mycenter/myOrder_refund4.js?v=biyao_cd89831"
        type="text/javascript"></script>
<script src="/h/pc/www/js/mycenter/common.js?v=biyao_e44562c"
        type="text/javascript"></script>
<script  src="/h/pc/common/js/ui/dialog.js?v=biyao_130c013"
         type="text/javascript"></script>
<script src="/h/pc/common/js/ui/loadmask.js?v=biyao_5aac5cc"
        type="text/javascript"></script>
<script src="/h/pc/www/js/product/lazyloadIM.js?v=biyao_2f2a448"
        type="text/javascript"></script>
<script type="text/javascript">
...
<script>
    function addwl(that){
            ...
            success: function (datas) {
                if (datas.success == true) {
                    ...
                    try{
                        ...
                        {
                            str = str + '<div class="wl_dl"><span class="w150">'+jsons[i].accept_time+'</span><span class="w280">'+jsons[i].remark+'</span></div>';
                        }
                        $('.wl_dl_w').html(str);
                        if ($(that).attr('orderStatus') == 3 && jsons[ca-1].opcode == 3) {
                            str = '<span class="inline col_666 mg_t10">生产进度</span><span class="inline col_f60 mg_l15 mg_t10">'+jsons[ca-1].rate+'%&nbsp;&nbsp;&nbsp;'+jsons[ca-1].processname+'</span></br>'+
                            '<span class="inline  progress_box mg_t10"><span class="inline active" style="width:'+jsons[ca-1].rate+'%"></span></span>';
                        ...
                        $('.wl_dl_w').css('background-image','none').html('<div class="pd10" align="center">获取信息错误<a href="/MyCenter/MyOrderDetail?orderId='+$(that).attr('orderId')+'" class="col_link ">查看详细</a><div>');
                    }
                }
                else{
                    $('.wl_dl_w').css('background-image','none').html('<div class="pd10" align="center">获取信息错误<a href="/MyCenter/MyOrderDetail?orderId='+$(that).attr('orderId')+'" class="col_link ">查看详细</a><div>');
        ...
        /* $.post(window.ControllerSite+'/SfExpress/QueryExpressInfo','tarcking_number='+$(that).attr('order')+'&orderId='+$(that).attr('orderId'),function(wl_data){
         var str = "";
         try{
         var jsons = eval('(' + wl_data.data + ')');
         var ca = jsons.length;
         if(ca>5){
         var $more = $(that).find('.c_wl_w').find(".c_wl_f");
         $($more).removeClass("none");
         $($more).prev().removeClass("none");
         };
         for(var i=ca-1;i>=(ca-5>0?ca-5:0);i--)
         {
         str = str + '<div class="wl_dl"><span class="w150">'+jsons[i].accept_time+'</span><span class="w280">'+jsons[i].remark+'</span></div>';
         ...
         $('.wl_dl_w').html(str);
         if ($(that).attr('orderStatus') == 3 && jsons[ca-1].opcode == 3) {
         $(that).find('.progress_box').html(jsons[ca-1].rate + '<span class="inline active" style="width:' + jsons[ca-1].rate + '%"></span>');
         $(that).find('.progress_box').prev().html(jsons[ca-1].processname);
         }
         }catch(e){
         $('.wl_dl_w').css('background-image','none').html('<div class="pd10" align="center">获取信息错误<a href="/www.biyao.com/MyCenter/MyOrderDetail?orderId=121409267635858" class="col_link ">查看详细</a><div>');
         }
         }) */
